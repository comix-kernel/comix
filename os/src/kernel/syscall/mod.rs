...
impl_syscall!(sys_setsockopt, net_syscall::setsockopt, (i32, i32, i32, *const u8, u32));
impl_syscall!(sys_getsockopt, net_syscall::getsockopt, (i32, i32, i32, *mut u8, *mut u32));
impl_syscall!(sys_accept4, net_syscall::accept4, (i32, *mut u8, *mut u32, i32));
impl_syscall!(sys_sendto, net_syscall::sendto, (i32, *const u8, usize, i32, *const u8, u32));
impl_syscall!(sys_recvfrom, net_syscall::recvfrom, (i32, *mut u8, usize, i32, *mut u8, *mut u32));
impl_syscall!(sys_getsockname, net_syscall::getsockname, (i32, *mut u8, *mut u32));
impl_syscall!(sys_getpeername, net_syscall::getpeername, (i32, *mut u8, *mut u32));
