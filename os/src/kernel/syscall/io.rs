...
pub fn read(fd: usize, buf: *mut u8, count: usize) -> isize {
    ...
    let result = {
        ...
        static READ_LOG_COUNT: core::sync::atomic::AtomicUsize = core::sync::atomic::AtomicUsize::new(0);
        ...
        if log {
            ...
            let ty = if file.as_any().is::<crate::vfs::impls::stdio_file::StdinFile>() {
                "STDIN"
            } else if file.as_any().is::<crate::vfs::impls::char_dev_file::CharDeviceFile>() {
                "CHARDEV"
            } else {
                "OTHER"
            };
